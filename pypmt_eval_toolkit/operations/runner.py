...
def solve(args):
    ...
    try:
        ...
        with tempfile.TemporaryDirectory(dir=args.run_dir) as tmpdirname:
            ...
            dumpresult['task-result']['summary']['log_messages'] = [] if result.log_messages is None else list(map(lambda l:l.message if 'message' in dir(l) else str(l), result.log_messages))
